...
const portalCameraComponent = {
  ...
  const promptFlowComponent = {
    init() {
      ...
      this.el.sceneEl.addEventListener('realityready', () => {
        ...
        this.prompt.innerHTML = 'Tap to say hi!'
  ...
  export {portalCameraComponent, tapToPlacePortalComponent, promptFlowComponent, spinComponent, placePortalComponent}
